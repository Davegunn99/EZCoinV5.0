...
public:
    CMainParams() {
        ...
        */
        ...
        vSeeds.emplace_back("seed1.myezcoin.com", true);
        vSeeds.emplace_back("seed2.myezcoin.com", true);
        vSeeds.emplace_back("seed3.myezcoin.com", true);
        vSeeds.emplace_back("seed4.myezcoin.com", true);
