...
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 18759
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 18760
...
if [ $1 -eq 0 ]; then
	...
	%{_sbindir}/semanage port -d -p tcp 18759
	%{_sbindir}/semanage port -d -p tcp 18760
	for selinuxvariant in %{selinux_variants}; do
